...
public class RisingWater : MonoBehaviour
{
    ...
    {
        Vector3 highestCheckpoint = worldManager.StartOfLevelSpawnPoint;
        ...
        if (transform.position.y > highestCheckpoint.y)
        {
            worldManager.LevelEnded = true;
        }
        else if (transform.position.y > flame.SpawnPoint.y)
        {
